...
C     ----------
     ...
     $   ), ZERO)
      ...
      CALL OXXXXX(P(0,5),MDL_MS,NHEL(5),+1*IC(5),W(1,5))
      CALL FFV1P0_3(W(1,1),W(1,3),GC_3,ZERO, FK_ZERO,W(1,6))
      CALL FFV1_2(W(1,2),W(1,4),GC_1,MDL_MS, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,7),W(1,5),W(1,6),GC_1,AMP(1))
      CALL FFV2_3_3(W(1,1),W(1,3),GC_57,GC_51,MDL_MZ, FK_MDL_WZ,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV2_3_0(W(1,7),W(1,5),W(1,8),GC_55,GC_49,AMP(2))
      CALL FFS2_3(W(1,1),W(1,3),GC_90,MDL_MH, FK_MDL_WH,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL FFS2_0(W(1,7),W(1,5),W(1,9),GC_96,AMP(3))
      CALL FFV1_1(W(1,5),W(1,4),GC_1,MDL_MS, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,2),W(1,7),W(1,6),GC_1,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV2_3_0(W(1,2),W(1,7),W(1,8),GC_55,GC_49,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFS2_0(W(1,2),W(1,7),W(1,9),GC_96,AMP(6))
      CALL FFV1_2(W(1,1),W(1,4),GC_3,MDL_ME, FK_ZERO,W(1,7))
      CALL FFV1P0_3(W(1,2),W(1,5),GC_1,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,7),W(1,3),W(1,9),GC_3,AMP(7))
      CALL FFV2_3_3(W(1,2),W(1,5),GC_55,GC_49,MDL_MZ, FK_MDL_WZ,W(1,8))
C     Amplitude(s) for diagram number 8
      CALL FFV2_3_0(W(1,7),W(1,3),W(1,8),GC_57,GC_51,AMP(8))
      CALL FFS2_3(W(1,2),W(1,5),GC_96,MDL_MH, FK_MDL_WH,W(1,6))
