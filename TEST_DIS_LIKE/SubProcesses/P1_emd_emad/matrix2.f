...
C     
C     Process: e- d~ > e- a d~ WEIGHTED<=6 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   , ZERO)
      ...
      CALL IXXXXX(P(0,5),MDL_MD,NHEL(5),-1*IC(5),W(1,5))
      CALL FFV1P0_3(W(1,1),W(1,3),GC_3,ZERO, FK_ZERO,W(1,6))
      CALL FFV1_2(W(1,5),W(1,4),GC_1,MDL_MD, FK_ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 3
      CALL FFS2_0(W(1,7),W(1,2),W(1,9),GC_83,AMP(3))
      CALL FFV1_1(W(1,2),W(1,4),GC_1,MDL_MD, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,5),W(1,7),W(1,6),GC_1,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV2_3_0(W(1,5),W(1,7),W(1,8),GC_55,GC_49,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFS2_0(W(1,5),W(1,7),W(1,9),GC_83,AMP(6))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFS2_3(W(1,5),W(1,2),GC_83,MDL_MH, FK_MDL_WH,W(1,6))
